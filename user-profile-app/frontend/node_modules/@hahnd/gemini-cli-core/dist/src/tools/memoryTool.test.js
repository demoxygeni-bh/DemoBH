...
describe('MemoryTool', () => {
    ...
    describe('performAddMemoryEntry (static method)', () => {
        ...
        it('should create section and save an instruction if file does not exist', async () => {
            ...
            await MemoryTool.performAddMemoryEntry(instruction, testFilePath, mockFsAdapter);
...
`;
        ...
        it('should correctly trim and add an instruction that starts with a dash', async () => {
            mockFsAdapter.readFile.mockResolvedValue(`${INSTRUCTION_SECTION_HEADER}\n`);
        ...
        it('should handle error from fsAdapter.writeFile', async () => {
            ...
            await expect(MemoryTool.performAddMemoryEntry(instruction, testFilePath, mockFsAdapter)).rejects.toThrow('[MemoryTool] Failed to add instruction entry: Disk full');
        });
    });
    describe('execute (instance method)', () => {
        ...
        it('should have correct name, displayName, description, and schema', () => {
            ...
            expect(memoryTool.description).toContain('Saves a permanent, immutable instruction for long-term memory.');
            expect(memoryTool.schema).toBeDefined();
            expect(memoryTool.schema.name).toBe('save_instruction');
            expect(memoryTool.schema.parameters?.properties?.instruction).toBeDefined();
        });
        it('should call performAddMemoryEntry with correct parameters and return success', async () => {
            ...
            expect(performAddMemoryEntrySpy).toHaveBeenCalledWith(params.instruction, expectedFilePath, expectedFsArgument);
        ...
        it('should handle errors from performAddMemoryEntry', async () => {
            ...
            const underlyingError = new Error('[MemoryTool] Failed to add instruction entry: Disk full');
            ...
            expect(result.returnDisplay).toBe(`Error saving instruction: ${underlyingError.message}`);
        });
    });
